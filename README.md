...
### 🔧 Projects
- **[Enterprise .NET Authentication Microservice](https://github.com/kloggenberg/auth-system)**: A containerized .NET application focused on secure architectural separation and identity management.
    - **Key Feature:** Fully **Dockerized** workflow to ensure environment parity and seamless CI/CD integration across development and production.
    - **Tech Stack:** C#, .NET Core, Docker, JWT Authentication, RESTful API Design.
